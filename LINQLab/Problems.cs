...
namespace LINQLab
{
    class Problems
    {
        ...
        private void RProblemOne()
        {
            ...
            Console.WriteLine($"\nRead Problem One: Total User count: {count}");
        ...
        */
        ...
        public void RProblemTwo()
        {
            ...
            Console.WriteLine("\nRead Problem Two: Products less than or equal to $100");
        ...
        public void RProblemThree()
        {
            ...
            Console.WriteLine("\nRead Problem Three: Products with names containing 's'");
        ...
        public void RProblemFour()
        {
            ...
            Console.WriteLine("\nRead Problem Four: Retrieve all users registered before 2016");
            var before2016Users = _context.Users.Where(u => u.RegistrationDate.Value.Year < 2016);
        ...
        public void RProblemFive()
        {
            ...
            // Then print each user's email and registration date to the console.
            Console.WriteLine("\nRead Problem Five: Find users registered AFTER 2016 and BEFORE 2018");
            var after2016Before2018Users = _context.Users.Where(u => u.RegistrationDate.Value.Year > 2016 && u.RegistrationDate.Value.Year < 2018);
            foreach (User user in after2016Before2018Users)
            {
                Console.WriteLine($"\nEmail: {user.Email}\nRegistration Date: {user.RegistrationDate}");
            }
        }
        ...
        public void RProblemSix()
        {
            ...
            Console.WriteLine("\nRead Problem Six: Retrieve shopping cart products for 'afton@gmail.com'");
            var aftonsItems = _context.ShoppingCartItems.Where(s => s.User.Email.Equals("afton@gmail.com"));
            foreach(ShoppingCartItem item in aftonsItems)
            {
        ...
        */
        ...
        public void RProblemSeven()
        {
            ...
            Console.WriteLine("\nRead Problem Seven: Get sum of product prices for 'oda@gmail.com'");
            var odasTotalPrice = _context.ShoppingCartItems.Where(s => s.User.Email.Equals("oda@gmail.com")).Select(sc => sc.Product.Price).Sum();
            Console.WriteLine($"Total Price for Oda: ${odasTotalPrice}");
        ...
        private void UProblemOne()
        {
            ...
            Console.WriteLine("\nUpdate Problem One: Updating a Product's price");
        ...
        private void UProblemTwo()
        {
            ...
            Console.WriteLine("\nUpdate Problem Two: Update newly created user to 'Employee' role");
        ...
        private void DProblemOne()
        {
            ...
            // HINT: Use a Loop
            Console.WriteLine("\nDelete Problem One: Delete product relationships for 'oda@gmail.com' from ShoppingCart table");
        ...
        private void DProblemTwo()
        {
            ...
            Console.WriteLine("\nDelete Problem Two: Removing user 'oda@gmail.com'");
